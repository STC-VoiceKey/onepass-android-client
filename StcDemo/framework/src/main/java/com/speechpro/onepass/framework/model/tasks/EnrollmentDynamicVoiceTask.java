 ...
 * @since 26.04.16
 */
public class EnrollmentDynamicVoiceTask extends ExceptionAsyncTask<VoiceSample, Void, Void> {
    private final RegistrationTransaction registrationTransaction;

    public EnrollmentDynamicVoiceTask(RegistrationTransaction registrationTransaction) {
        super();
